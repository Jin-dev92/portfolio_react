...
import {
  PrecipitationImageSrc,
  WeatherImageSrc,
  WindImageSrc,
} from "./constant/imageSrc";
  ...
  return (
    <FlexContainer direction={"row"}>
      <Card
        ...
        cover={
          <img
            alt="weather"
            src={
              alignData?.weather.SKY === SkyDetail.SUNNY
                ? WeatherImageSrc.SUNNY
                : alignData?.weather.SKY === SkyDetail.CLOUDY
                  ? WeatherImageSrc.CLOUDY
                  : WeatherImageSrc.CLOUD
            }
          />
        }
      >
        <Meta
          title="Weather"
          description={
            <CardDescription data={alignData?.weather} type={"weather"} />
          }
        />
      </Card>
      <Card
      ...
      >
        <Meta
          title="Wind"
          description={<CardDescription data={alignData?.wind} type={"wind"} />}
        />
      </Card>
      <Card
        hoverable
        ...
        cover={
          <img
            alt="precipitation"
            src={
              [PtyDetail.SNOW, PtyDetail.RAIN_AND_SNOW].includes(
                alignData?.precipitation,
              )
                ? PrecipitationImageSrc.SNOW
                : PrecipitationImageSrc.RAIN
            }
          />
        }
      >
