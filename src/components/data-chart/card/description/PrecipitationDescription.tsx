...
const PrecipitationDescription = ({data}) => {
    ...
    return (
        <Space direction={"vertical"}>
            ...
            <Text type={'secondary'}>강수 형태
                : {PTY === PtyDetail.NOTHING ? "없음" : PTY === PtyDetail.RAIN ? "비" : PTY === PtyDetail.RAIN_AND_SNOW ? "비/눈" : PTY === PtyDetail.SNOW ? "눈" : PTY === PtyDetail.HEAVY_RAIN ? "소나기" : "알 수 없음"}</Text>
            {
